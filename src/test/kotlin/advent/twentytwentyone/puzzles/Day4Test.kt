...
internal class Day4Test {
    ...
    @Test
    fun `Day 4 - Giant Squid - Part 1`() = runBlocking {
        val result = sut.partOne()
        assertEquals(41668, result)
    }

    @Test
    fun `Day 4 - Giant Squid - Part 2`() = runBlocking {
    ...
    fun partOneTestCase() = runBlocking {
        ...
        coEvery { getInput(any(), any()) } returns """7,4,9,5,11,17,23,2,0,14,21,24,10,16,13,6,15,25,12,22,18,20,8,19,3,26,1 
